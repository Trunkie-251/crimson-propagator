...
/// Base font
/datum/font/terminator_real
	name = "terminator  real"
	font_family = 'interface/fonts/TerminatorReal.ttf'
...
/datum/font/terminator_real/size_12pt
	name = "terminator real 12pt"
	height = 16
	ascent = 12
	descent = 4
	average_width = 7

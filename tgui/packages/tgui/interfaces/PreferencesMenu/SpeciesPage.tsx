...
const SpeciesPageInner = (
  ...
  // Synthetics are always the top of the list
  const syntheticIndex = species.findIndex(
    ([species]) => species === 'synthetic'
  );
  const swapWith = species[0];
  species[0] = species[syntheticIndex];
  species[syntheticIndex] = swapWith;

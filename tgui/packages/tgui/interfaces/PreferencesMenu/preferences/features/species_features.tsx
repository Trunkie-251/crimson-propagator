...
export const exoskeleton_head_color: Feature<string> = {
  name: 'Exoskeleton head color',
  component: FeatureColorInput,
};

export const exoskeleton_chest_color: Feature<string> = {
  name: 'Exoskeleton chest color',
  component: FeatureColorInput,
};

export const exoskeleton_r_arm_color: Feature<string> = {
  name: 'Exoskeleton right arm color',
  component: FeatureColorInput,
};

export const exoskeleton_l_arm_color: Feature<string> = {
  name: 'Exoskeleton left arm color',
  component: FeatureColorInput,
};

export const exoskeleton_r_leg_color: Feature<string> = {
  name: 'Exoskeleton right leg color',
  component: FeatureColorInput,
};

export const exoskeleton_l_leg_color: Feature<string> = {
  name: 'Exoskeleton left leg color',
  component: FeatureColorInput,
};

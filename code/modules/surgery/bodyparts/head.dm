/obj/item/bodypart/head
	...
	unarmed_damage_low = 5 // Yeah, biteing is pretty weak, blame the monkey super-nerf
...
/obj/item/bodypart/head/get_limb_icon(dropped)
	...
	if(dropped)
		...
		if(eye?.eye_icon_state && (head_flags & HEAD_EYESPRITES))
			var/image/eye_left = image('icons/mob/human/human_face.dmi', "[eye.eye_icon_state]_l", -BODY_LAYER, SOUTH)
			var/image/eye_right = image('icons/mob/human/human_face.dmi', "[eye.eye_icon_state]_r", -BODY_LAYER, SOUTH)

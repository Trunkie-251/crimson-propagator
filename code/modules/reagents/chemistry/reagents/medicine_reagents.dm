...
/datum/reagent/medicine/synth_nanites //Used exclusively by Syndicate medical cyborgs
	name = "Repair Nanites"
	description = "Active Synthetic micro-robots that repair cybernetic components."
	reagent_state = SOLID
	color = "#555555"
	overdose_threshold = 30
	ph = 11
...
/datum/reagent/medicine/synth_nanites/on_mob_life(mob/living/carbon/affected_mob, seconds_per_tick, times_fired)
...
/datum/reagent/medicine/synth_nanites/overdose_process(mob/living/carbon/affected_mob, seconds_per_tick, times_fired) //wtb flavortext messages that hint that you're vomitting up robots
	if(SPT_PROB(13, seconds_per_tick))
		affected_mob.reagents.remove_reagent(type, metabolization_rate*15) // ~5 units at a rate of 0.4 but i wanted a nice number in code
		affected_mob.vomit(20) // nanite safety protocols make your body expel them to prevent harmies
	..()
